...
router.get('/', function(req, res, next) {
  ...
  //res.render('index', { title: 'Express', msg : saml.toString(), msgbase64 : new Buffer(saml.toString()).toString('base64') });
  res.render('index', { title: 'Express', msg : message.toString(), msgbase64 : new Buffer(message.toString()).toString('base64') });
});
