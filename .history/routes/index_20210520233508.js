...
router.get('/', function(req, res, next) {
  ...
  sign.canonicalizationAlgorithm = "http://www.w3.org/2000/09/xmldsig#enveloped-signature";
  ...
  res.render('index', { title: 'Express', msg : saml.toString(), msgbase64 : new Buffer(saml.toString()).toString('base64') , msgunsign : message.toString()});
});
