...
router.get('/', function(req, res, next) {
  ...
  res.render('index', { title: '', msg : saml.toString(), msgbase64 : new Buffer(saml.toString()).toString('base64'), so : so , data: data , error : error});
});
