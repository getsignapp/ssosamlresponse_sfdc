...
router.get('/', function(req, res, next) {
  var privatekey = fs.readFileSync('public/dsa/privkey.pem');
  var cert = fs.readFileSync('public/dsa/cert.cer');
  ...
  function MyKeyInfo() {
	  ...
	  this.getKey = function(keyInfo) {
	    ...
	    return fs.readFileSync("public/dsa/cert.cer")
	  }
	}
  ...
  sig.signingKey = fs.readFileSync("public/dsa/privkey.pem");
